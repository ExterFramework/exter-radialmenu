...
RegisterNetEvent("QBCore:Client:OnPlayerLoaded") -- Memastikan status pekerjaan terupdate saat pemain masuk
AddEventHandler("QBCore:Client:OnPlayerLoaded", function()
    local Player = QBCore.Functions.GetPlayerData()
    myJob = Player.job.name
    isMedic = myJob == "ambulance"
    isPolice = myJob == "police"
    isTow = myJob == "tow"
    isTaxi = myJob == "taxi"
end)

RegisterNetEvent("QBCore:Client:OnJobUpdate") -- Memperbarui pekerjaan saat berubah
...
RegisterNetEvent('QBCore:Client:SetDuty') -- Memastikan status on duty diperbarui
